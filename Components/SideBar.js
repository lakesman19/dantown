...
// const router = useRouter()
  return (
    <div
      className={`${
        isSidebarOpen
          ? 'hidden md:block w-[220px] lg:block lg:w-[220px] bg-[#fff] fixed h-[100%] py-9 overflow-auto shadow-[rgb(113 122 131 / 11%) 0px 7px 30px 0px;] transition-[all] ease duration-[.3s] '
